...
S = Synapses(P, G, on_pre=''' v_post += (epsp0 + w_f)
                            w_f += (f_max - w_f)/2
                            ''')
S.connect(i=0,j=0)
...
ax1.set_yticks([])
ax1.set_title("Facilitating Synapse")
axw.plot(S_w_f.t/ms, 0.005*volt + S_w_f.w_f[0], 'g')
axw.set_ylim([0.0, 0.035])
